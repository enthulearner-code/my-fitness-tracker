...
1. **Dedicated Top Tabs (`st.tabs`)**:
   * **🏋️ Workouts Tab:** Designed specifically for exercises, tracking load (kg), and recording sets/reps seamlessly into your logs. Features an exercise-specific line chart for strength progression.
